...
<head>
    ...
    <style>
        ...
        .border-container {
            ...
            border-radius: 10px; /* Bo góc cho thẻ div */
            padding: 20px;
            background-color: #fff; /* Màu nền cho div */
...
<body class="container">
    ...
    <div class="container my-4 d-flex justify-content-center align-items-center" style="min-height: 80vh;">
        ...
        <div class="border border-secondary rounded p-4 shadow" style="max-width: 500px; width: 100%;">
            <form id="ticketSearchForm">
                <h4 class="mb-3">Tìm Vé Máy Bay</h4>
                <div class="mb-3">
                    <label for="ticketCode" class="form-label">Nhập mã vé:</label>
                    <input type="text" class="form-control" id="ticketCode" placeholder="Nhập mã vé" required>
                </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-body">
                    <p><strong>Mã vé:</strong> <span id="modalTicketCode">Mã vé của bạn sẽ được hiển thị ở đây</span></p>
